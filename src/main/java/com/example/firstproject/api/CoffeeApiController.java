...
public class CoffeeApiController {
    ...
    public ResponseEntity<Coffee> showCoffee(@PathVariable Long id){
    ...
    public ResponseEntity<Coffee> update(@PathVariable Long id,@RequestBody CoffeeForm dto){
        ...
        return updated !=null ? ResponseEntity.status(HttpStatus.OK).body(updated) : ResponseEntity.status(HttpStatus.OK).build();
    }
